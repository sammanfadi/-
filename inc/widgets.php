...
function mohtawa_widgets_init() {
    ...
    register_sidebar(array(
        ...
        'id' => 'sidebar-main',
        'description' => __('الشريط الجانبي الذي يظهر في صفحات المتاجر', 'mohtawa'),
    ...
    // تذييل الصفحة - العمود الأول
    register_sidebar(array(
        'name' => __('تذييل الصفحة - العمود الأول', 'mohtawa'),
        'id' => 'footer-1',
        'description' => __('العمود الأول في تذييل الصفحة', 'mohtawa'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    // تذييل الصفحة - العمود الثاني
    register_sidebar(array(
        'name' => __('تذييل الصفحة - العمود الثاني', 'mohtawa'),
        'id' => 'footer-2',
        'description' => __('العمود الثاني في تذييل الصفحة', 'mohtawa'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widget-title">',
        'after_title' => '</h4>',
    ...
    // تذييل الصفحة - العمود الثالث
    register_sidebar(array(
        'name' => __('تذييل الصفحة - العمود الثالث', 'mohtawa'),
        'id' => 'footer-3',
        'description' => __('العمود الثالث في تذييل الصفحة', 'mohtawa'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widget-title">',
        'after_title' => '</h4>',
    ...
    // تذييل الصفحة - العمود الرابع
    register_sidebar(array(
        'name' => __('تذييل الصفحة - العمود الرابع', 'mohtawa'),
        'id' => 'footer-4',
        'description' => __('العمود الرابع في تذييل الصفحة', 'mohtawa'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widget-title">',
        'after_title' => '</h4>',
